...
class ModelSaved(models.Model):
    """Liste de tout les modéles sauvegardés et leur utilisateur associé"""
    userMail = models.CharField(max_length=80, default=None, null=True, blank=True)
    nameOfTheModel = models.CharField(max_length=80, default=None, null=True, blank=True)
    isActive = models.BooleanField(default=False)
    keywords = models.CharField(max_length=10000, default=None, null=True, blank=True)
class StreamProcess(models.Model):
    ...
    keys = models.ForeignKey(ApiKey, null=True, on_delete=models.PROTECT)
...
class AbstractTweet(models.Model):
    ...
    text_nettoye = models.CharField(max_length = 280, null = True, blank = True, default = None)
    truncated = models.BooleanField(default=False)
    lang = models.CharField(max_length=9, null=True, blank=True, default=None)

    # annotation du tweet de l'utilisateur en intéréssant ou non
    interesting = models.IntegerField(null=True, blank=True, default=None)
    #email de l'utilisateur
    emailUser = models.CharField(max_length =100, null = True, blank = True, default = None)
    # métadonnées du tweet 
    metaData = models.CharField(max_length =4000, null = True, blank = True, default = None)
